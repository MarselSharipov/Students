...
class StudentListAdapter(private val onItemClick: (Int) -> Unit,
                         private val onItemDeleteClick: (Int) -> Unit): RecyclerView.Adapter<StudentHolder>() {

    private val items = mutableListOf<Student>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
            StudentHolder.create(parent, onItemClick, onItemDeleteClick)
